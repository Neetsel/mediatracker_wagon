...
ActiveRecord::Schema[7.1].define(version: 2026_01_30_000636) do
  ...
  create_table "games", force: :cascade do |t|
    ...
    t.string "developers_ref", default: [], array: true
    t.string "publishers_ref", default: [], array: true
    t.string "platforms_ref", default: [], array: true
  end
